"""
Correlates annual runoff change with hydrologic drivers and land cover change.
Joins the PSIMF hydrologic-change table with LCCM developed-cover proportions,
then computes Pearson/Spearman correlations between runoff change and each
candidate driver.
"""
