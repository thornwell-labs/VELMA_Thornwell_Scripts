"""
Plots a chosen VELMA variable over time for selected year(s) from a single
daily results or cell data writer file. Single-file variant of
daily_visualizer.py.
"""
...
data_to_plot = 'Snow dynamics'
# List of possible values for data_to_plot:
# Evapotranspiration, Snow dynamics, Nitrate, NH4, DON, DOC, Temperature, Biomass, Detritus, Humus
...
def plot_daily_data(params, data_file, years, sum_columns, file_switch):
    ...
    if sum_columns:
        ...
        params.data_columns = [params.sum_name]
    ...
    # df_filtered.to_csv('path/to/VELMA_Watersheds/Elwha/Elwha_Working/Results/documents_20240826/'
    #                    'SnowDynamics.csv', index=False)
    plt.xlabel('Date')
...
plot_daily_data(parameter_groups[data_to_plot], data_file, years, sum_columns, file_switch)
